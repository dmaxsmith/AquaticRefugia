...
##Subset to include variables that have been selected as refugia indicators for this habitat group##
...
#Adjust indicators to match relationship between diversity and richness, adjust Z scores for things we want to minimize (change in conditions and velocity and soil bulk density) 
